function run(){
    ...
    while(!Hash.toString().substr(0, 3).includes("0")){
        noncelol = noncelol + 1;
...
//18 = while(!Hash.toString().substr(0, 5).includes("00")){
//100 = while(!Hash.toString().substr(0, 10).includes("000")){
